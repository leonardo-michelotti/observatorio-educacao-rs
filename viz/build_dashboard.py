...
HTML = r"""<div class="paper">
  ...
  <header class="masthead">
    ...
    <p class="standfirst">Nos anos iniciais, a cidade acompanha o Brasil e o Rio Grande do Sul.
      ...
      dado oficial do INEP, lidos de ponta a ponta.</p>
  ...
  <section class="hero">
    <div class="hero-lead">
      <p class="lede">O IDEB vai de 0 a 10. Siga a linha de Santa Maria por dentro de uma
        mesma foto — 2023 — à medida que o aluno sobe as etapas:</p>
    </div>
  ...
  <article class="act">
    ...
    <figure class="fig" data-chart data-ind="ideb" data-eta="ef_anos_iniciais"
      data-ann='[{"niv":"santa_maria","ano":2005,"text":"4,3 em 2005","ty":4.65,"tano":2005},{"niv":"santa_maria","ano":2023,"text":"5,8 — empata com o RS, acima do Brasil","ty":5.35,"tano":2018}]'></figure>
  </article>
  ...
  <article class="act">
    <div class="act-txt">
      ...
      <h2>A pandemia derrubou o aprendizado — e a aprovação escondeu.</h2>
      <p>O IDEB mistura duas coisas: <i>quanto o aluno aprende</i> (a nota SAEB) e <i>quantos
        ...
        proficiência em Matemática despencou — a perda de aprendizagem da pandemia — enquanto a
  ...
  <article class="act">
    <div class="act-txt">
      ...
      <p>A aprovação que era exemplar no Fundamental (~97%) despenca no Médio: <b>78%</b> em
        ...
        3,1 (2019) para 2,4 (2023) — e o Médio é rede estadual, não municipal, o que aponta para
        <i>onde</i> está o problema.</p>
    </div>
    <figure class="fig" data-chart data-ind="taxa_aprovacao" data-eta="em"
      data-ann='[{"niv":"santa_maria","ano":2022,"text":"78% — abaixo de tudo","ty":72,"tano":2018},{"niv":"brasil","ano":2025,"text":"Brasil: 95%","ty":90,"tano":2021}]'></figure>
  </article>
  ...
  <footer class="foot">
    <div class="foot-notes">
      ...
      <p>Os dados vêm do INEP via Base dos Dados, e foram auditados célula a célula. A tabela de
        ...
        do RS, por exemplo, aparece como 4–11% em <i>todas</i> as fatias de rede, o que é
        impossível. A fonte oficial do INEP é limpa, mas seu servidor é inacessível deste
        ambiente. Por isso a distorção idade-série só aparece nos anos finais (a única série que
        sobrevive à auditoria) e o RS some de alguns recortes. Nada foi maquiado; o que não dá
        para afirmar com honestidade, ficou de fora.</p>
    </div>
    <div class="foot-meta">
...
@media (max-width:560px){ .paper{padding:44px 18px 56px;} body{font-size:17px;} }
